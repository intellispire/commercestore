...
/**
 * Setup the global "cs_order_adjustmentmeta" database table
 *
 * @since 3.0
 */
final class Order_Adjustment_Meta extends Table {
	...
	protected function set_schema() {
		...
		cs_order_adjustment_id bigint(20) unsigned NOT NULL default '0',
		meta_key varchar(255) DEFAULT NULL,
		meta_value longtext DEFAULT NULL,
		PRIMARY KEY (meta_id),
		KEY cs_order_adjustment_id (cs_order_adjustment_id),
