...
function cs_recurring_admin_scripts( $hook ) {
	...
	$ajax_vars = array(
		'singular'            => _x( 'time', 'Referring to billing period', 'commercestore' ),
		'plural'              => _x( 'times', 'Referring to billing period', 'commercestore' ),
		'enabled_gateways'    => cs_get_enabled_payment_gateways(),
		'invalid_time'        => array(
			'paypal'          => __( 'PayPal Standard requires recurring times to be set to 0 for indefinite subscriptions or a minimum value of 2 and a maximum value of 52 for limited subscriptions.', 'commercestore' ),
		),
		'delete_subscription' => __( 'Are you sure you want to delete this subscription?', 'commercestore' ),
		'action_edit'         => __( 'Edit', 'commercestore' ),
		'action_cancel'       => __( 'Cancel', 'commercestore' ),
	);
