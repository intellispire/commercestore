...
if ( ! defined( 'CS_PLUGIN_DIR' ) ) exit;

/**
 * CS_Customer_Query.
 *
 * This class remains for backwards compatibility. Please use cs_get_customers() instead.
 *
 * @deprecated 3.0.0
 */
class CS_Customer_Query extends CS\Database\Queries\Customer {
