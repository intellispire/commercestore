 ...
 */
function cs_add_adjustment_meta( $adjustment_id, $meta_key, $meta_value, $unique = false ) {
	return add_metadata( 'cs_adjustment', $adjustment_id, $meta_key, $meta_value, $unique );
}
 ...
 */
function cs_delete_adjustment_meta( $adjustment_id, $meta_key, $meta_value = '' ) {
	return delete_metadata( 'cs_adjustment', $adjustment_id, $meta_key, $meta_value );
}
 ...
 */
function cs_get_adjustment_meta( $adjustment_id, $key = '', $single = false ) {
	return get_metadata( 'cs_adjustment', $adjustment_id, $key, $single );
}
 ...
 */
function cs_update_adjustment_meta( $adjustment_id, $meta_key, $meta_value, $prev_value = '' ) {
	return update_metadata( 'cs_adjustment', $adjustment_id, $meta_key, $meta_value, $prev_value );
}
 ...
 */
function cs_delete_adjustment_meta_by_key( $meta_key ) {
	return delete_metadata( 'cs_adjustment', null, $meta_key, '', true );
}