...
/**
 * CS_Register_Meta Class
 *
 * @since 2.5
 */
class CS_Register_Meta {
	...
	/**
	 * Get the one true instance of CS_Register_Meta.
	 *
	 * @since  2.5
	 * @return $instance
	 */
	static public function instance() {
		...
		if ( !self::$instance ) {
			self::$instance = new CS_Register_Meta();
		}
	...
	public function register_download_meta() {
		...
		register_meta(
			...
			array(
				...
				'single'            => true,
				'type'              => 'object',
				'description'       => __( 'An array of variable prices for the product.', 'commercestore' ),
				'show_in_rest'      => array(
					'schema' => array(
						'type'                 => 'object',
						'properties'           => array(),
		...
		register_meta(
			...
			array(
				...
				'single'            => true,
				'type'              => 'array',
				'description'       => __( 'An array of product IDs to associate with a bundle.', 'commercestore' ),
				'show_in_rest'      => array(
					'schema' => array(
						'type'  => 'array',
						'items' => array(
	...
	/**
	 * Register the meta for the cs_payment post type.
	 *
	 * @since  2.5
	 * @return void
	 */
	public function register_payment_meta() {
		...
		register_meta(
			...
			array(
				'object_subtype'    => 'cs_payment',
				'sanitize_callback' => 'sanitize_email',
				'type'              => 'string',
				'description'       => __( 'The email address associated with the purchase.', 'commercestore' ),
			)
		);
		...
		register_meta(
			...
			array(
				...
				'sanitize_callback' => array( $this, 'intval_wrapper' ),
				'type'              => 'int',
				'description'       => __( 'The Customer ID associated with the payment.', 'commercestore' ),
			)
		);
		...
		register_meta(
			...
			array(
				...
				'sanitize_callback' => array( $this, 'intval_wrapper' ),
				'type'              => 'int',
				'description'       => __( 'The User ID associated with the payment.', 'commercestore' ),
			)
		);
		...
		register_meta(
			...
			array(
				'sanitize_callback' => 'sanitize_text_field',
				'type'              => 'string',
				'description'       => __( 'The IP address the payment was made from.', 'commercestore' ),
			)
		);
		...
		register_meta(
			...
			array(
				'sanitize_callback' => 'sanitize_text_field',
				'type'              => 'string',
				'description'       => __( 'The unique purchase key for this payment.', 'commercestore' ),
			)
		);
		...
		register_meta(
			...
			array(
				'sanitize_callback' => 'cs_sanitize_amount',
				'type'              => 'float',
				'description'       => __( 'The purchase total for this payment.', 'commercestore' ),
			)
		);
		...
		register_meta(
			...
			array(
				'sanitize_callback' => 'sanitize_text_field',
				'type'              => 'string',
				'description'       => __( 'Identifies if the purchase was made in Test or Live mode.', 'commercestore' ),
			)
		);
		...
		register_meta(
			...
			array(
				'sanitize_callback' => 'sanitize_text_field',
				'type'              => 'string',
				'description'       => __( 'The registered gateway that was used to process this payment.', 'commercestore' ),
			)
		);
		...
		register_meta(
			...
			array(
				'sanitize_callback' => array( $this, 'sanitize_array' ),
				'type'              => 'array',
				'description'       => __( 'Array of payment meta that contains cart details, downloads, amounts, taxes, discounts, and subtotals, etc.', 'commercestore' ),
			)
		);
		...
		register_meta(
			...
			array(
				'sanitize_callback' => 'cs_sanitize_amount',
				'type'              => 'float',
				'description'       => __( 'The total amount of tax paid for this payment.', 'commercestore' ),
			)
		);
		...
		register_meta(
			...
			array(
				'sanitize_callback' => 'sanitize_text_field',
				'type'              => 'string',
				'description'       => __( 'The date this payment was changed to the `completed` status.', 'commercestore' ),
			)
		);
	}
	...
	public function sanitize_price( $price ) {
		...
		$allow_negative_prices = apply_filters( 'cs_allow_negative_prices', false );

		if ( ! $allow_negative_prices && $price < 0 ) {
			$price = 0;
		}

		return cs_sanitize_amount( $price );
	}
