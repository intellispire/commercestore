 ...
 */
function cs_add_order_transaction( $data ) {
	...
	$order_transactions = new CS\Database\Queries\Order_Transaction();
 ...
 */
function cs_delete_order_transaction( $order_transaction_id = 0 ) {
	$order_transactions = new CS\Database\Queries\Order_Transaction();
 ...
 */
function cs_update_order_transaction( $order_transaction_id = 0, $data = array() ) {
	$order_transactions = new CS\Database\Queries\Order_Transaction();
 ...
 *
 * @param int $order_transaction_id Order transaction ID.
 * @return CS\Orders\Order_Transaction|false Order_Transaction object if successful,
 *                                            false otherwise.
 */
function cs_get_order_transaction( $order_transaction_id = 0 ) {
	$order_transactions = new CS\Database\Queries\Order_Transaction();
 ...
 *                                            false otherwise.
 */
function cs_get_order_transaction_by( $field = '', $value = '' ) {
	$order_transactions = new CS\Database\Queries\Order_Transaction();
 ...
 *
 * @see \CS\Database\Queries\Order_Transaction::__construct()
 *
 * @since 3.0
 *
 * @param array $args Arguments. See `CS\Database\Queries\Order_Transaction` for
 *                    accepted arguments.
 * @return \CS\Orders\Order_Transaction[] Array of `Order_Transaction` objects.
 */
function cs_get_order_transactions( $args = array() ) {
 ...
 *             passed.
 */
function cs_count_order_transactions( $args = array() ) {
	...
	// Query for count(s).
	$order_transactions = new CS\Database\Queries\Order_Transaction( $r );
 ...
 */
function cs_get_order_id_from_transaction_id( $transaction_id = '' ) {
	...
	if ( ! empty( $transaction_id ) ) {
		...
		$transaction = cs_get_order_transaction_by( 'transaction_id', $transaction_id );
