<?php
/**
 * CommerceStore API for creating Email template tags
 *
 ...
 *
 * To add tags, use: cs_add_email_tag( $tag, $description, $func ). Be sure to wrap cs_add_email_tag()
...
class CS_Email_Template_Tags {
	...
	/**
	 * Do a specific tag, this function should not be used. Please use cs_do_email_tags instead.
	 *
	 * @since 1.9
	 *
	 * @param $m message
