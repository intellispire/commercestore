 ...
 * can do certain things within the CommerceStore store.
 *
 * @since 1.4.4
 */
class CS_Roles {
	...
	public function add_roles() {
		add_role( 'shop_manager', __( 'Shop Manager', 'commercestore' ), array(
			'read'                   => true,
			'edit_posts'             => true,
			'delete_posts'           => true,
		...
		add_role( 'shop_accountant', __( 'Shop Accountant', 'commercestore' ), array(
			'read'         => true,
			'edit_posts'   => false,
			'delete_posts' => false,
		) );

		add_role( 'shop_worker', __( 'Shop Worker', 'commercestore' ), array(
			'read'         => true,
			'edit_posts'   => false,
			'upload_files' => true,
			'delete_posts' => false,
		...
		add_role( 'shop_vendor', __( 'Shop Vendor', 'commercestore' ), array(
			'read'         => true,
			'edit_posts'   => false,
			'upload_files' => true,
			'delete_posts' => false,
