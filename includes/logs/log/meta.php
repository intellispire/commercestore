 ...
 */
function cs_add_log_meta( $log_id, $meta_key, $meta_value, $unique = false ) {
	return add_metadata( 'cs_log', $log_id, $meta_key, $meta_value, $unique );
}
 ...
 */
function cs_delete_log_meta( $log_id, $meta_key, $meta_value = '' ) {
	return delete_metadata( 'cs_log', $log_id, $meta_key, $meta_value );
}
 ...
 */
function cs_get_log_meta( $log_id, $key = '', $single = false ) {
	return get_metadata( 'cs_log', $log_id, $key, $single );
}
 ...
 */
function cs_update_log_meta( $log_id, $meta_key, $meta_value, $prev_value = '' ) {
	return update_metadata( 'cs_log', $log_id, $meta_key, $meta_value, $prev_value );
}
 ...
 */
function cs_delete_log_meta_by_key( $meta_key ) {
	return delete_metadata( 'cs_log', null, $meta_key, '', true );
}