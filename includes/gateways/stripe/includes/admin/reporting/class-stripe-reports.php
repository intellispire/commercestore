...
class CS_Stripe_Reports {
	...
	public function __construct() {
		...
		//Graph Reports
		add_filter( 'cs_report_views', array( $this, 'add_stripe_card_reports_view' ) );
		add_action( 'cs_reports_view_stripe', array( $this, 'display_stripe_report' ) );
	...
	public function get_stripe_payments_by_date( $day = null, $month = null, $year = null, $hour = null, $include_taxes = false ) {
		...
		$args = apply_filters( 'cs_get_stripe_payments_by_date', array(
			'nopaging'    => true,
		...
		if ( $payments ) {
			foreach ( $payments as $payment ) {
				...
				$existing = $payment->get_meta( '_csx_used_existing_card' );
				$tax      = 0;
