<?php
/**
 * CS_Stripe_Utils_Exceptions_Attribute_Not_Found exception class
 *
 * @package CS_Stripe
 * @since   2.6.19
 */
...
/**
 * Implements an CS_Stripe_Utils_Exceptions_Attribute_Not_Found exception thrown when a given
 ...
 */
class CS_Stripe_Utils_Exceptions_Attribute_Not_Found extends OutOfBoundsException {
	 ...
	 *                                   Default null.
	 * @return CS_Stripe_Exceptions_Attribute_Not_Found Exception instance.
	 */
