=== CommerceStore - Simple eCommerce for Selling Digital Files ===
Author URI: https://commercestore.com
Plugin URI: https://commercestore.com
Contributors: commercestore, mordauk, sunnyratilal, chriscct7, section214, sumobi, sdavis2702, cklosows, mindctrl, sksmatt, SpencerFinnell, johnstonphilip, brashrebel, drewapicture, johnjamesjacoby, nosegraze, littlerchicken, lisacee
Donate link: https://commercestore.com/donate/
...
CommerceStore is a complete eCommerce solution for selling digital products on WordPress. Learn more at [EasyDigitalDownloads.com](https://commercestore.com/?utm_source=home&utm_medium=description_tab&utm_content=home&utm_campaign=readme).

= Sell effortlessly =

Whether it is [software](https://commercestore.com/blog/selling-software/?utm_medium=readme&utm_source=wporg&utm_campaign=cs-plugin&utm_term=description), [documents](https://commercestore.com/blog/selling-documents/?utm_medium=readme&utm_source=wporg&utm_campaign=cs-plugin&utm_term=description), [photos](https://commercestore.com/blog/selling-photographs/?utm_medium=readme&utm_source=wporg&utm_campaign=cs-plugin&utm_term=description), [ebooks](https://commercestore.com/blog/selling-ebooks/?utm_medium=readme&utm_source=wporg&utm_campaign=cs-plugin&utm_term=description), [songs](https://commercestore.com/blog/selling-audio-and-music/?utm_medium=readme&utm_source=wporg&utm_campaign=cs-plugin&utm_term=description), [graphics](https://commercestore.com/blog/selling-graphics-and-digital-artwork/?utm_medium=readme&utm_source=wporg&utm_campaign=cs-plugin&utm_term=description), [videos](https://commercestore.com/blog/selling-videos/?utm_medium=readme&utm_source=wporg&utm_campaign=cs-plugin&utm_term=description), or any other type of media file, CommerceStore provides a complete system for effortlessly selling your digital products.

> CommerceStore is an invaluable tool that I use throughout my business and for my clients. I love its simplicity yet powerful features and library of useful extensions. CommerceStore stands out as one of the only affordable options for scaling a business centered around providing digital ecommerce sites to its clients.

> Mark Hunter - Mark of Approval

= All the eCommerce features you need =

Do you prefer an eCommerce solution which is simple and intuitive or one which is rich in features? Too often that tradeoff is one online sellers need to make. Fortunately, CommerceStore manages to be easy enough for eCommerce beginners to configure without sacrificing any important functionality.

> CommerceStore gives me a solid platform out of the box, with the flexibility of being able to customize anything I want or need to. The best of both worlds!
...
- **Works with any theme** - Let your chosen WordPress theme handle the design. CommerceStore will fit right in.
- [And much more](https://commercestore.com/cs-features/?utm_medium=readme&utm_source=wporg&utm_campaign=cs-plugin&utm_content=much-more&utm_term=description)!

= Localized for your language =

CommerceStore has been translated into more than two dozen languages and new translations are being added all the time, letting you have a natural, native experience, regardless of where you live. If your language is not available, we welcome translation contributions! See our [FAQ](http://docs.commercestore.com/article/1082-what-spoken-languages-does-commercestore-support?utm_source=docs&utm_medium=description_tab&utm_content=languages&utm_campaign=readme).

= Support for many payment gateways, including Stripe and PayPal =

The internet has made it possible for anyone to sell their products to a world-wide audience. No matter where you live, CommerceStore can be your e-Commerce solution. We offer integrations for the most common merchant processors and, through 3rd party extensions, support for many, many more as well.

Payment gateways supported in the free CommerceStore plugin:
...
> What can I say? Stripe is my go-to payment processor and without this [integration] I don't know what I would do. Connect CommerceStore to your Stripe account in seconds and you're done! Having a simple test mode toggle is also a valuable development tool.

> Matt Whiteley - Whiteley Designs

See our [payment gateways category](https://commercestore.com/downloads/category/gateways/?utm_source=extensions&utm_medium=description_tab&utm_content=gateways&utm_campaign=readme) in the extensions catalogue for a complete list of supported merchant processors. There are also a large number of additional payment gateways developed and supported by [3rd party developers](https://commercestore.com/3rd-party-extensions/#gateways).

CommerceStore is a verified member of the [Stripe partner program](https://stripe.com/accept-payments/commercestore). This program recognizes software that meets Stripe's strict quality requirements and provides users of CommerceStore and Stripe with the confidence they need to trust us both with their payment integrations.

= Take your store further with extensions =

With add-on plugins from our [extensions catalogue](https://commercestore.com/downloads/?utm_source=extensions&utm_medium=description_tab&utm_content=extensions&utm_campaign=readme) you can super-charge your digital store. Some of our extension highlights include:

* [Stripe Pro](https://commercestore.com/downloads/stripe-gateway/?utm_source=extension&utm_medium=description_tab&utm_content=stripe-pro&utm_campaign=readme) removes the additional 2% processing fee as well as adds the ability to accept pre-approved payments (extension must be installed and activated)
* [PayPal Commerce Pro](https://commercestore.com/downloads/paypal-commerce-pro/?utm_source=extension&utm_medium=description_tab&utm_content=paypal-commerce-pro&utm_campaign=readme) allows customers to pay by debit or credit card as well as alternative payments such as Sofort, iDEAL, Bancontact, and Giropay (extension must be installed and activated)
* [Software Licensing](https://commercestore.com/downloads/software-licensing/?utm_source=extension&utm_medium=description_tab&utm_content=software-licensing&utm_campaign=readme) provides a complete solution for selling software license keys and distributing software updates to customers
* [Recurring Payments](https://commercestore.com/downloads/recurring-payments/?utm_source=extension&utm_medium=description_tab&utm_content=recurring-payments&utm_campaign=readme) allows store owners to sell recurring subscriptions for digital products using payment gateways like Stripe and PayPal
* [Frontend Submissions](https://commercestore.com/downloads/frontend-submissions/?utm_source=extension&utm_medium=description_tab&utm_content=frontend-submissions&utm_campaign=readme) transforms your store into a full-featured multi-vendor marketplace
* [Commissions](https://commercestore.com/downloads/commissions/?utm_source=extension&utm_medium=description_tab&utm_content=commissions&utm_campaign=readme) enables store owners to easily track earnings for product vendors
* [Free Downloads](https://commercestore.com/downloads/free-downloads/?utm_source=extension&utm_medium=description_tab&utm_content=free-downloads&utm_campaign=readme) allows free products to be purchased more easily by bypassing the standard checkout form
* [Zapier](https://commercestore.com/downloads/zapier/?utm_source=extension&utm_medium=description_tab&utm_content=zapier&utm_campaign=readme) automates your store by connecting CommerceStore with more than 700 other web services and products
* [Reviews](https://commercestore.com/downloads/product-reviews/?utm_source=extension&utm_medium=description_tab&utm_content=reviews&utm_campaign=readme) allows customers to leave reviews and feedback on the products they have purchased
* [Recommended Products](https://commercestore.com/downloads/recommended-products/?utm_source=extension&utm_medium=description_tab&utm_content=recommended-products&utm_campaign=readme) increases revenue by showing customers recommendations on additional products to purchase based on real sales data
* [Content Restriction](https://commercestore.com/downloads/content-restriction/?utm_source=extension&utm_medium=description_tab&utm_content=content-restriction&utm_campaign=readme) allows site owners to restrict access to page content to paying customers
* [Mailchimp](https://commercestore.com/downloads/mailchimp/?utm_source=extension&utm_medium=description_tab&utm_content=mailchimp&utm_campaign=readme) connects your store to your Mailchimp account so you can easily subscribe customers to email lists based on which products they purchase
* [AWeber](https://commercestore.com/downloads/aweber/?utm_source=extension&utm_medium=description_tab&utm_content=aweber&utm_campaign=readme) connects your store to your AWeber account so you can easily subscribe customers to email lists based on what they purchase
* [Amazon S3](https://commercestore.com/downloads/amazon-s3/?utm_source=extension&utm_medium=description_tab&utm_content=amazon-s3&utm_campaign=readme) lets you securely host files on Amazon S3 for more reliable and secure file delivery
* [Dropbox File Store](https://commercestore.com/downloads/dropbox-file-store//?utm_source=extension&utm_medium=description_tab&utm_content=dropbox-file-store/&utm_campaign=readme) lets you securely host files in your Dropbox account for more reliable and secure file delivery

These are just a few of the extensions we offer to help you optimize your store and sell more files. See our complete [extensions catalogue](https://commercestore.com/downloads/?utm_source=extensions&utm_medium=description_tab&utm_content=extensions&utm_campaign=readme) for more. There are also hundreds of extensions created by CommerceStore community members, which can be found on our [3rd Party Extensions page](https://commercestore.com/3rd-party-extensions/?utm_source=3rd-party-extensions&utm_medium=description_tab&utm_content=3rd-party-extensions&utm_campaign=readme).

= Built with developers in mind =

Extensible, adaptable, and open source -- CommerceStore is created with developers in mind. Consult our detailed [developer documentation](http://docs.commercestore.com/collection/174-developer-docs?utm_source=wporg&utm_medium=readme&utm_content=documentation&utm_campaign=dev-docs) to learn how you can extend and customize your CommerceStore powered eCommerce store.

The CommerceStore API makes it possible for developers to make customizations such as:
...
> As a developer, CommerceStore is very pleasant to work with since you can absolutely extend anything available within CS.

> Yudhistira Mauris - WP House

= Get help =

CommerceStore is backed by top-notch technical support from our globally distributed full-time support team. We also have an [extensive documentation site available](https://docs.commercestore.com/?utm_medium=readme&utm_source=wporg&utm_campaign=lite-plugin&utm_content=docs&utm_term=description). If you’re looking for faster support via email, we encourage you to [purchase an CommerceStore pass](https://commercestore.com/pricing/?utm_medium=readme&utm_source=wporg&utm_campaign=lite-plugin&utm_content=upgrade&utm_term=description) or premium extension.

> CommerceStore has been a long standing, rock-solid e-commerce solution for WordPress. The team lives and breathes WordPress, understands the platform, and is embedded in the community.
...
- [The 12 Most Popular Digital Products You Can Sell Online](https://commercestore.com/blog/the-12-most-popular-digital-products-you-can-sell-online/?utm_medium=readme&utm_source=wporg&utm_campaign=cs-plugin&utm_term=description)
- [How to Add Lead Magnets in WordPress to Grow Your Email List](https://commercestore.com/blog/how-to-add-lead-magnets-in-wordpress-to-grow-your-email-list/?utm_medium=readme&utm_source=wporg&utm_campaign=cs-plugin&utm_content=lead-magnets&utm_term=description)
- [How to Successfully Launch Your Digital Product](https://commercestore.com/blog/how-to-successfully-launch-your-digital-product/?utm_medium=readme&utm_source=wporg&utm_campaign=cs-plugin&utm_content=launch&utm_term=description)
- [Protecting Your Digital Products](https://commercestore.com/blog/protecting-your-digital-products/?utm_medium=readme&utm_source=wporg&utm_campaign=cs-plugin&utm_content=protecting&utm_term=description)
- [The Top Ten Benefits of Selling Digital Products](https://commercestore.com/blog/top-10-benefits-selling-digital-products/?utm_medium=readme&utm_source=wporg&utm_campaign=cs-plugin&utm_content=benefits&utm_term=description)

**[Subscribe to our newsletter](https://commercestore.com/subscribe/?utm_medium=readme&utm_source=wporg&utm_campaign=lite-plugin&utm_content=subscribe&utm_term=description)** to get posts like these in your inbox as soon as they’re published.

= Contribute to CommerceStore =

Development for this plugin happens in a public GitHub repository to better facilitate contributions from an active community of users, developers and designers. If you have a suggestion, bug report, patch, or pull request, please feel free to [contribute here](https://github.com/commercestore/commercestore) or to our [code snippet library](https://github.com/commercestore/library).

= Looking for something else? =

If CommerceStore doesn’t quite fit your needs, take a look at some of our other projects.

- [WP Simple Pay](https://wpsimplepay.com/?utm_medium=readme&utm_source=wporg&utm_campaign=cs-plugin&utm_content=something-else&utm_term=description) – A lightweight Stripe payments plugin
- [AffiliateWP](https://affiliatewp.com/?utm_medium=readme&utm_source=wporg&utm_campaign=cs-plugin&utm_content=something-else&utm_term=description) – A full-featured affiliate marketing solution
- [Sugar Calendar](https://sugarcalendar.com?utm_medium=readme&utm_source=wporg&utm_campaign=cs-plugin&utm_content=something-else&utm_term=description) – WordPress event management made simple
...
5. For detailed setup instructions, vist the official [Documentation](http://docs.commercestore.com/?utm_source=docs&utm_medium=installation_tab&utm_content=documentation&utm_campaign=readme) page.

== Frequently Asked Questions ==

= Where can I find complete documentation? =

Full searchable docs for CommerceStore and all our extensions can be found at [http://docs.commercestore.com/](http://docs.commercestore.com/?utm_source=docs&utm_medium=faq_tab&utm_content=documentation&utm_campaign=readme)

= Where can I ask for help with my digital eCommerce store? =

You can submit a support ticket or pre-sale question from our [support page](https://commercestore.com/support/?utm_source=docs&utm_medium=faq_tab&utm_content=support&utm_campaign=readme) at anytime.

= Which file types can I sell? =

Any file type can be sold using CommerceStore. You can sell .PDF, .DOC, .MP3, .MOV, .EPUB, .PSD, .MP4, .JPG, or any other extension which exists. On the product creation form, there is a file upload field which will accept any file type. Whatever file is uploaded to that field is the file customers will receive instantly when they complete a purchase.

= Is an SSL certificate required to sell digital products? =

CommerceStore can function without an SSL certificate just fine, making it easy to set up in a testing or development environment.  We still strongly recommend you have an SSL certificate for your live store, both for security and for the peace of mind of your customers. [Documentation here](http://docs.commercestore.com/article/994-how-to-set-up-ssl?utm_source=docs&utm_medium=faq_tab&utm_content=documentation&utm_campaign=readme)

= What themes work with CommerceStore? =

Any properly written theme will work with CommerceStore.

That said, we have a nice collection of free themes that come with support for CommerceStore, requiring much less design work on the part of the store owner.

[See the free themes here.](https://commercestore.com/themes/?utm_source=docs&utm_medium=faq_tab&utm_term=free_themes&utm_content=faqs&utm_campaign=readme)

= Is there a sample import file I can use to setup a demo store? =

Yes! Simply go to Tools > Import and install the WordPress Importer, then navigate to wp-content/plugins/commercestore/assets/ and select the sample-products-import.xml file. This will create several sample products and plugin pages for you.

= Can I import all the products from my existing store into CS? =

Yes! We do have a [basic import solution](http://docs.commercestore.com/article/216-can-i-import-and-export-products?utm_source=docs&utm_medium=faq_tab&utm_term=import_addon&utm_content=faqs&utm_campaign=readme) that imports a CSV file, so if you can get your data into the appropriate format then we can import it.

= My payments are being marked as "pending" =

There are several reasons this happens. Please follow the suggestions [here](http://docs.commercestore.com/article/190-payments-not-marked-as-complete?utm_source=docs&utm_medium=faq_tab&utm_content=faqs&utm_campaign=readme).
...
There are several different ways to visually display your product catalogue, each [documented here](http://docs.commercestore.com/category/870-product-display?utm_source=cs_readme&utm_medium=faq_tab&utm_content=faqs&utm_campaign=readme).

= Can I set up an affiliate program? =

Yes! CommerceStore integrates directly with several affiliate platforms that provide complete affiliate systems you can use to award commissions to your affiliate marketers. This means when affiliates refer customers to you, and those customers buy your products, those affiliates earn a commission from you.

[Check out AffiliateWP](https://affiliatewp.com?utm_source=cs_readme&utm_medium=faq_tab&utm_content=home&utm_campaign=readme)
...
[Invoices](https://commercestore.com/downloads/cs-invoices/?utm_source=cs-invoices&utm_medium=faq_tab&utm_content=pdf-invoices&utm_campaign=readme)

= Are recurring payments supported? =

Yes, through the use of our commercial addon called [Recurring Payments](https://commercestore.com/downloads/recurring-payments/?utm_source=docs&utm_medium=faq_tab&utm_term=recurring_addon&utm_content=faqs&utm_campaign=readme). [Full documentation here](http://docs.commercestore.com/article/1142-recurring-payments---overview?utm_source=docs&utm_medium=faq_tab&utm_term=recurring_addon&utm_content=faqs&utm_campaign=readme). The Recurring Payments extension allows you to create subscriptions so that customers continue paying you over time. This is great for selling memberships, courses, all access passes, software licenses, and other products which require an ongoing payment.
...
* New: Add an admin notice when the CommerceStore Debug Log is enabled.
...
* Fix: Stripe - CommerceStore 3.0: Incorrect tax amount being charged when customer uses a different country from the store's base country.
...
* New: Add notifications to CommerceStore screens.
* New: Reorganize some settings locations to make them more predictable for users.
* New: Improve user opportunities to give feedback to the CommerceStore team.
* New: Add support for webp images.
* Improvement: Add the `cs_ajax_remove_discount_response` filter inside the AJAX remove discount function.
...
* Fix: CommerceStore Pass Manager was not saving the license key to the pass data during activation.
...
* Dev: Introduce the CommerceStore extension registry for managing licensed extensions.
* Dev: Save CommerceStore licensed products to options for improved reliability.
* Dev: Explicitly declare the `payment_stats` property for `CS_Payment_Stats`.
* Dev: Improve performance of `cs_get_settings_tabs`.
...
* New: Add contextual CommerceStore header to relevant pages.
* New: Add quick link to CommerceStore reports in the Dashboard menu.
...
* Fix: `_cs_deprecated_function()` - only trigger error with backtrace if there is a backtrace provided.
* Fix: API requests have unexpected output when using Query Monitor.
* Dev: Updated `CS_SL_Plugin_Updater` to version 1.9.1.
...
* Fix: WP-CLI - `price_id` parameter not working with `wp cs payments create` command.
...
* Fix: The cs_items_in_cart cookie wasn't setting the correct attributes on sites with SSLs.
* Fix: Some bundled images hadn't been optimized.
* Fix: The discounts API endpoint could not filter a discount by ID.
* Fix: When making an CommerceStore Wallet deposit, the cart HTML would be removed when taxes were enabled.

= 2.10.6, June 22, 2021 =
* New: Added license upgrade notices to CommerceStore admin pages.
* Improvement: The discount API endpoint now includes `excluded_products`.
* Improvement: The Hummingbird cache plugin is now detected in `cs_is_caching_plugin_active()`.
...
* Dev: Stripe - Update refund logic to use new refunds API in CommerceStore 3.0.
...
* New: Add link to Termageddon for Terms of Agreement and Privacy Policy fields within CommerceStore settings.
...
= 2.10, March 9, 2021 =
* New: Accept credit cards, Apple Pay, Google Pay, and Microsoft Pay with the included Stripe Standard payment gateway. Read more about this feature here: https://commercestore.com/cs-stripe-integration
...
* Fix: There was a memory leak when calling get_password_reset_key() caused by CS's customers database class.
...
* Fix: Account for an undefined index of cs-cart-downloads.
...
* Dev: When checking if a file download limit is reached, the price_id of the purchased download is now passed to the cs_is_file_at_download_limit filter.
* Dev: The cs_download_price_table_head and cs_download_price_table_row actions have been formally deprecated.

= 2.9.26, October 1, 2020 =
* Fix: Installation of the Jilt extension was allowed for non-super admins on multisite installs.
* Dev: Improved DocBloc for cs_has_user_purchased() function.
...
* New: CommerceStore Login forms now support plugins that limit failed login attempts.
* New: Failed login attempts on the CommerceStore Login form now return proper HTTP status codes, when possible.
...
* Fix: The cs_after_payment_actions action fired via cron was missing attributes.
* Fix: The SendWP connection link was visited if enter/return was pressed to update settings.
* New: Promotional elements added to CommerceStore admin screens.
...
* Fix: Refactored cs_get_payment_status to work when Payment statuses are translated.
* Fix: Improved the compatibility of file downloads with hosting configurations that involve symlinks for uploads.
* Dev: Added the 'cs_show_nginx_redirect_notice' filter to allow programmatically hiding the nginx file protection admin notice.
* Dev: Added polyfills for is_countable and is_iterable into CommerceStore core.

= 2.9.17, October 2, 2019 =
* Security Fix: Prevent an authentication bypass to the CommerceStore REST API when no API keys exist.
...
* Fix: Multiple improvements with the CS_License handler.
...
* Fix: Corrected a conditional check typo when determining if settings page is CommerceStore related.

= 2.9.11, January 6, 2019 =
* Fix: PayPal PDT amount validation fails for some accounts due to missing payment_gross field.
* Tweak: PayPal email address now registered to CS_Customer during IPN processing if the email is not already registered.
...
* Fix: Incorrect DocBlock for cs_currency_filter.
...
* Dev: All available contextual arguments were added to the cs_requested_file filter.

= 2.9.7, September 10, 2018 =
* Fix: The cs_cart_amount data attributes were not updated when quantities were changed at checkout.
* Fix: Updated the zip/postal code validation for Mongolia.
* Fix: Updating a download meta to 0 using the CS_Download class would not save correctly.
...
* Fix: Corrected some issues with CommerceStore Sessions and WP Admin.
* Fix: Test Purchase Email Subject ampersands were getting improperly HTML encoded.
* New: Updated the CS_SL_Plugin_Updater to support icons and have a health check.
* New: Added the date generated to system info.
* New: CommerceStore API now supports "order" and "orderby" parameters for the products endpoint.
...
* https://commercestore.com/development/2018/07/05/important-update-to-ajax-requests-in-commercestore-2-9-4
...
* cs_get_register_fields()
* cs_get_login_fields()
* cs_payment_mode_select()
* cs_checkout_hidden_fields()
...
* Fix: PHP 7.2 Compatibility - Some PHP notices were being thrown while activating CommerceStore.
* Fix: The CS_Cart class now forces the cart contents to always be an array.
...
* Tweak: CommerceStore sessions can now be started when in the wp-admin path.
...
* GDPR: Added new "Privacy" tab to the CommerceStore Settings.
...
* Fix: Email addresses that contained a + would not be removed via [cs_profile_editor].
...
* Fix: Corrected an issue with showing payment method icons when using CommerceStore in a non-standard installation.
* Fix: Corrected a CSS conflict in the customer card view for the additional emails section.
* Fix: The cs_checkout_cart_columns function now properly counts the number of columns in the cart display.
...
* Fix: There was an unnecessary update of _cs_payment_user_id when constructing CS_Payment objects.
...
* New: The debug log view now shows the path to the currently used CommerceStore Debug log file.
...
* New: A message is now displayed on the [cs_register] shortcode when the user is already logged in.
...
* New: Any page containing the [download_checkout] shortcode returns true for cs_is_checkout().
* New: Upgraded to the latest version of the Chosen library.
* New: Added United Kingdom Counties to pre-populated "states" list.
* New: CS_Payment::add_note now escapes the HTML provided.
...
* Fix: PayPal Standard: Totals with discounts could calculate differently between CommerceStore and PayPal, preventing completion of the purchase.
...
* Tweak: The cs_get_download method now returns an `CS_Download` object instead of a `WP_Post`.
* Tweak: Corrected some URLs to the CommerceStore site that were using an old URL.
...
* Fix: WordPress file editor was not working when CommerceStore was not active.
...
* Fix: Hardened CommerceStore actions for use with WP Cron.
...
* Fix: Warning when converting dates to timestamps in CS_Stats::convert_date()
...
* Fix: Corrected a misspelled function cs_render_dowwn_tax_options.
...
* Fix: Improved the performance of the CS_Customer class.
* Fix: Improved the new Debug Log View usability.
* Fix: Corrected an issue with cs_user_pending_verification() when logged in as an admin.
...
* New: Added a filter for cs_get_errors().
* New: Added link to ipinfo.io for the IP address on a file download log.
* Tweak: Removed an unused display_price argument in cs_get_purchase_link().
...
* Fix: Incorrectly called function on CS_Payment::get_discounted_amount.
...
* Tweak: Added $price_id to the cs_purchase_receipt_after_files action.
...
* New: Added more parameters to the cs_requested_file_name filter.
...
* Fix: Calls to CS_Customer->update_meta could throw a notice if called to early in the WordPress load process.
* Fix: The cs_get_users_purchased_products function did not respect the status argument passed in.
* Fix: The base state/province displayed empty when no pre-populated state or province data was available.
* Fix: Performance improvements to cs_get_discounts.
...
* New: Added the CS_Logging class, to allow for easier debugging by developers.
* New: The country name has been added to the payment export.
* New: Added a discounts_total property to the CS_Payment class.
...
* Tweak: Fixed CSS targeting on cs_repeatable_thumbnail_size_field selector.

= 2.8.6, September 11, 2017 =

* Fix: Amazon Payments could cause Javascript error on checkout.
* Fix: cs_delete_option() helper function failed to fully remove option.
* Fix: It was possible to create a discount using cs_store_discount() without specifying a discount code.
...
* New: Added filter cs_load_scripts_in_footer to allow programmatic modifications of where frontend scripts are loaded.
...
* Fix: Improved security of CS_Session.
...
* Tweak: Added inline docs for cs_payment_meta filter.
* Tweak: Ensure CS_Cart:get_discounts() return type is consistent.

= 2.8.4, August 16, 2017 =

* Fix: Minor improvements to cs_get_customer_address() function.
...
* Tweak: Added search_columns argument to the CS_Customer_Query class.
...
* Fix: Prevent duplicate queries when cs_get_purchase_id_by_key() is called more than once for the same payment key.
...
* New: add_meta() and delete_meta() methods added to CS_Payment
* New: Position of errors on checkout can now be changed through cs_global_checkout_script_vars filter
* New: cs_after_payment_actions action now fired through WP Cron after payment is completed
* New: CS_Customer_Query class introduced
...
* Tweak: cs-ajax.js and cs-ajax.min.js now loaded in wp_footer
* Tweak: Improved performance of CS_Customer by avoiding duplicate query to get notes
...
* Tweak: Chosen dropdown field of CS_HTML_Elements now supports "multiple" parameter
* Tweak: Added a link to gateways extension category on gateway settings page to make gateways more easily discoverable
* Tweak: Updated the CommerceStore add-on updater class to version 1.6.13
* Tweak: Added new cs_log_file_download_download_files filter and cs_log_file_download_file_id filter to get_logs() method of the file download list table
* Tweak: Empty categories now shown on Earnings by Category report
* Tweak: CS_Customer object added to completed payment actions
* Tweak: Current customer instance added to all hooks and filters in CS_Customer
* Tweak: Download link expiration time now shown on System Info
* Tweak: Added cs_checkout_billing_details_address filter to customer billing details on checkout
...
* Tweak: Added new cs_price_option_output filter to function that displays variable prices
...
* Fix: Fatal error due to undefined function cs_extension_has_beta_support()
...
* Fix: get_payments() method of CS_Payments_Query affects global $post
...
* Fix: select() method of CS_HTML_Elements always uses "Downloads" as search placeholder
...
* Fix: CS_Payment was using invalid modified_date instead of date.
* Fix: Recovering a guest payment prompted user to login to complete the purchase.
* New: Add cs_get_report_dates_default_range filter to report date range.
...
* Fix: cs_unset_cart_discount() is case sensitive when it should not be
...
* Tweak: CS_Graph class now supports an "addition_options" parameter
...
* Fix: cs_has_user_purchased() can return false incorrectly
...
* Tweak: Added new filter and action to cs_has_user_purchased()
* Tweak: Renamed Czech Republic to Czechia
* Tweak: Log in form on checkout now accepts log-in by email
* Tweak: Added new cs_download_inner_class filter
...
* Fix: cs-page class improperly added to all site pages when Test Mode is enabled
...
* Fix: Query parameters not properly setup when calling multiple instances of CS_Payments_Query
...
* Fix: Incorrect date set for "end_date" in CS_Stats class
...
* Fix: No error messages shown on [cs_register] shortcode
...
* Fix: Browser cache not flushed when CommerceStore CSS is updated
...
* Fix: It is possible for the ID returned from CS_DB::insert() to be returned incorrectly
...
* Fix: cs-submit class accidentally removed from some buttons on the front end
...
* New: CS_Payments_Query now keeps a record of the initial arguments used, to allow better extensibility.
...
* Fix: Incorrect function name in new CS_Discount class was being checked.

= 2.7, February 13, 2017 =
* New: Introduced CS_Cart class for managing the shopping cart contents.
...
* New: Messages registered with cs_set_error are now output via a hook.
* New: Introduced the CS_Discount class.
...
* New: Introduce cs_get_payment which uses WordPress object cache to improve performance of getting payments.
* New: CS_Payment and cs_get_payment now accept a payment transaction ID.
* New: Introduced a more CS-specific downloads shortcode [cs_downloads].
* New: Moved cs-ajax.min script to footer to allow async loading of jQuery.
...
* Tweak: Replaced all instances of get_post_meta() for payments with cs_get_payment_meta().
* Tweak: Deprecated cs_get_earnings_by_date & cs_get_sales_by_date.
...
* Tweak: Updated Profile Editor markup to match current CommerceStore markup format.
...
* Tweak: Added a per-download hook to the cs_receipt shortcode.
* Tweak: Unit tests no longer hit the network. They are so much faster now.
* Tweak: Removed use of global variable $cs_options.
* Tweak: Placeholders can now be defined for text fields when using the CommerceStore Settings API.
...
* Fix: CS_License did not properly support `item_id`.
...
* Fix: The cs_download_redirect_to_checkout filter wasn't respecting the desired outcome in some configurations.
...
* Fix: CS_Download::setup_download() now identify $download as a WP_Post object type.
...
* Fix: Moved cs_undo_purchase_on_refund to deprecated-functions.php.
...
* Tweak: Improved performance of cs_get_payment_by(), making account pages faster
...
* Fix: Calling cs_is_discount_valid() results in cart errors being set
...
* Fix: check_update() method is called twice in CS_SL_Plugin_Updater class
...
* Fix: cs_has_active_discounts could return false when there were active discounts.
* Fix: Supplying an invalid date range on reports could produce an incorrect graph.
* Fix: CS_Payment::update_meta could produce a PHP warning when used.
...
* Fix: CommerceStore HTML Select input had many cases where mixed variable types could trigger errors and warnings.
* Fix: cs_get_users_purchases had outdated PHPDocs.
...
* Fix: `cs_get_users_purchased_products` would fail if the first product ID supplied was not a download.
...
* Fix: The CS_SL_Plugin_Updater::check_update method could possibly be called twice.
...
* New: CommerceStore Settings API now supports adding classes to registered settings.
...
* New: Add action hook called "cs_payment_saved" for when CS_Payment::save() is run.
...
* Tweak: Update author and author URI to CommerceStore.
...
* Fix: CS_Payment::setup_tax did not always contain proper data.
...
* Fix: Custom icons via cs_accepted_payment_icons were unwrapped.
* Fix: Fees for specific download and price IDs did not check if the item or price ID is in the cart.
* Fix: CommerceStore API was always returning version 1 by default.
...
* Fix: Email property set twice in cs_insert_payment().
...
* Fix: The cs_get_random_download() should return an item.
* Fix: Potential PHP warning when using CS_Payment->save().
...
* Fix: cs_update_payment_status() creates new blank payment record if given an invalid payment ID.
...
* Fix: The cs_payment_meta filter was not respecting values modified during the filter when saving a payment.
...
* Fix: cs_stats_{key} transients causing performance issues.
...
* Fix: Sequential payment number not assigned when creating payments with CS_Payment.
...
* Tweak: Update CS_SL_Plugin_Updater.php to latest version.
* Tweak: Correct references of 'short code' to 'shortcode'.
* Tweak: Filter "cs_get_cart_discounts_html" does not pass relevant arguments for developers.
* Tweak: Update payments export to use CS_Payment.
...
* New: Add cs_get_php_arg_separator_output on System Info.
...
* Fix: Incorrect redirect URL for [cs_login] shortcode
* Fix: Spelling errors in internal documentation
* New: Added $items parameter to cs_post_add_to_cart action

= 2.6.5, July 25, 2016 =
* Fix: Incorrect parameters passed to cs_is_checkout()
* Fix: Some records skipped during CSV import
* Fix: update_option() cannot be used to update CommerceStore settings
...
* Fix: cs_get_variable_prices() returns prices even when variable prices are disabled
...
* Fix: Rely on Customer's User ID when CS_Payment::setup_user_id has incorrect data.
...
* Fix: It is possible for cs_get_ip() to return a CSV of IP addresses.
...
* Tweak: Improved inline documentation for cs_get_download_file_url()
...
* Fix: DocBloc for cs_delete_option function is incorrect.
...
* New: If enabled, send checkin data when CommerceStore is upgraded.
* New: Add a filter for cs_price_options() that allows adding classes to the output.
...
* New: Filters added to CS_Customer increase and decrease methods.
...
* New: Add new cs-table class to all tables outputted by CommerceStore.
...
* New: Add get_payments() method to the CS_Customer class.
* New: Make download ID more visible on the downloads list table.
* New: Add filters to the add_fee() and get_fees() methods of CS_Fees class.
...
* New: Deprecate cs_get_success_page_url().
* New: Add default redirect option to [cs_login] and [cs_register] shortcodes.
* New: Introduce customer meta table.
* New: Add JavaScript trigger to cs_load_gateway() for 3rd party hooks.
* New: Support post__in as an argument in [downloads] shortcode.
* New: Final declaration removed from CS_Payment class.
* New: Allow cs_get_payment_status to also accept a payment ID.
* New: Support additional email addresses for customers.
* New: Add actions into the increase/decrease sales/earnings methods of the CS_Download class.
* New: Added CSV Import functionality.
* Tweak: Use internal methods when getting sales counts and files in CS_Download class.
* Tweak: Add campaign tracking to links in the contextual help menus.
* Tweak: Improve cs-admin.css coding standards.
* Tweak: Update translation .mo files and add development tool for downloading translations from Language Packs.
* Tweak: Improve CommerceStore Licenses tab in settings.
* Tweak: Improve cs_object_to_array method.
...
* Tweak: PayPal Standard Buy Now was updated to use CS_Payment.
* Fix: New User Email alerts have incorrect header.
* Fix: Transient being bypassed in CS_Payment_Stats::get_earnings().
* Fix: Remove unused variable and duplicate post_where filters in CS_Payment_Stats.
* Fix: Correct spelling error in cs_get_paypal_redirect().
* Fix: Improved cache key generation in CS_Payment_Stats::get_earnings().
...
* Fix: cs_get_users_purchased_products() can sometimes try an array_mege on a non-array value.
...
* Fix: Improve performance of transient deletion when uninstalling CommerceStore.
...
* Fix: CS_API hooks for API key generation fire when extending the base class.
...
* Fix: Replace calls to global settings variable with cs_get_option().
* Fix: Duplicate get_post_meta calls in CS_Download class.
...
* Fix: Item fees not taken into account when using CS_Payment_Stats::get_earnings() for a specific download.
...
* Fix: Correct a capitilzation error in CS_Customer class usage during cs_insert_payment
...
* Tweak: Introduced new cs_checkout_user_error_checks action during purchase processing
...
* Tweak: Added PHP version, CommerceStore version, install date, and WordPress version to opt-in tracking payload
...
* Fix: Missing validation for discount code ID in cs_decrease_discount_usage()
...
* Tweak: Added new "cs_payment_advanced_filters_row" filter
...
* Fix: fees_total property not set up in CS_Payment object
...
* Fix: CommerceStore transients not deleted during uninstall
...
* Fix: discount_dropdown() method of CS_HTML_Elements does not support non-item label
...
* Fix: [cs_receipt payment_key="false"] results in error retrieving receipt message
...
* Fix: Price override in add_download() method of CS_Payment does not respect price of 0
* Fix: Dash incorrectly shown after product name on the receipt page
* Fix: Missing P tag on View Order Details screen
* Tweak: Replace usage of $cs_options with cs_get_option() helper function
* Tweak: URL in New User Notification email now linked
* Tweak: cs_price() now displays the value of the Default price option
* New: Introduced cs_payment_currency_default filter

= 2.5.7, February 10, 2016 =

* New: Added refund() method to CS_Payment class
* New: Added filters to enable/disable product and customer stat adjustments during refunds
* New: Added new hooks to CS_Payment class that run before payment is setup
* Tweak: Improved taxonomy labels for categories and tags
* Tweak: Automatically flush permalinks when a 404 is detected on CommerceStore archive pages
* Tweak: Add proper 403 headers to REST API
* Tweak: Removed usage of soon-to-be-deprecated function get_currentuserinfo()
* Tweak: Improved CSS formatting for cs.css
...
* Fix: Maybe unserialize user_info array in CS_Payment
...
* Fix: PHP notices in cs_process_add_to_cart() when AJAX is disabled
...
* Fix: Status passed to cs_insert_payment() not respected. Caused subscription payments to be marked as pending
* Fix: cs_is_payment_complete() returns false improperly
...
* New: CS_Payment class for developers
...
* New: File download history now available in REST API at /cs-api/file-download-logs
...
* New: Added filter to disable "cs_items_in_cart" cookie
* Tweak: Improved customer options in purchase history export
* Tweak: All meta keys now registered with WordPress
* Tweak: CS_API now runs on wp hook for improved performance
...
* Fix: Properly run install routine when network activating CS
...
* Fix: cs_render_receipt_in_browser() outputs invalid markup
* Fix: Parameters for [cs_receipt] shortcode not working properly
* Fix: Payment Method fields not hidden when 100% discount code is applied
* Fix: Running CS_Payment_Stats::get_earnings() twice gives inconsistent values
* Fix: Running CS_Payment_Stats::get_sales() twice gives inconsistent values
...
* Fix: Corrected spelling for cs_customer_recent_purchases_actions hook
...
* Fix: Removed unused code in cs_get_purchase_link() function
* Fix: Corrected spelling error in CS_Stats class
...
* Fix: cs_get_current_page_url() returns improper URL when WordPress is installed in sub folder
* Tweak: Improved formatting of the welcome screen to match the styles of WordPress core

= 2.4.7, September 29, 2015 =

* Tweak: Changed text domain from "edd" to "commercestore"
...
* Fix: Warning: Missing argument 3 for cs_receipt_show_download_files()
* Fix: Quick Edits on Downloads not always expanding the form
* Fix: Occasional redirect loop caused by cs_enforced_ssl_redirect_handler()
...
* Fix: Non-object notice on /cs-api/customers endpoint
...
* Fix: Incorrect URl returned by cs_get_current_page_url() in some instances
...
* Tweak: Introduced cs_protected_directory_allowed_filetypes filter
* Tweak: Add $item to cs_receipt_show_download_files filter
...
* Fix: Removed unused function cs_add_ons_init()
...
* Fix: Variable typo in cs_is_admin_page()
...
* Tweak: cs_filter_success_page_content() not run early enough
...
* Fix: Correct cs_listen_for_failed_payments() sending post id, not WP_Post object
* Fix: Fix tax state not saving when text field

= 2.4.1, July 2, 2015 =

* Tweak: Updated Language Files
* Fix: cs_get_gateway_admin_label() should use cs_get_payment_gateways()
...
* New: Added date_field() method to CS_HTML_Elements class
...
* Tweak: Improved cs_is_admin_page() helper function for detecting when on specific CommerceStore admin pages
...
* Tweak: cs_recalculate_taxes() now includes a raw amount in the response
...
* Fix: cs_items_in_cart cookie disables cache improperly
...
* Tweak: Added filters to join and where clauses in cs_count_payments()
...
* Fix: cs_get_file_download_method called too late during download process
* Update: Translations Updated
* Tweak: Improvements to the CommerceStore Extensions page
...
* Fix: Prevent New Download Draft by using explicit create method in CS_Download
...
* Fix: Better checks in cs_get_payment_tax()
* Tweak: Allow clearing of cs_doing_upgrade
...
* Tweak: Automatically disable the cs_test_ajax_works() test if the Airplane Mode plugin is enabled
* Tweak: Updated translation files for many languages

= 2.3.2, March 14, 2015 =

* Fix: Slow performance in admin area due to cs_test_ajax_works() function
...
* New: Introduced cs_update_option() and cs_delete_option() functions
...
* New: Introduced CS_Customer class for interacting with customer records
* New: Introduced WP CLI command to create sample customers
* New: Introduced cs_purchase_form_user_info_fields hook
* New: Introduced cs_purchase_form_user_register_fields hook
* New: Introduced cs_download_after_thumbnail hook
* New: Introduced cs_download_after_title hook
* New: Introduced cs_download_after_content hook
* New: Introduced cs_download_after_price hook
* New: Introduced cs_before_purchase_history hook
* New: Introduced cs_after_purchase_history hook
* New: Introduced cs_email_show_links filter
* New: Updated translation files for numerous languages
* New: Introduced CS_Notices class for handling admin notices
...
* Tweak: Added line breaks to cs.css file in favor of single-line rules
* Tweak: Improved performance of cs_get_users_purchases() by querying the customer table directly
...
* Tweak: Improved standards throughout CommerceStore for usage of cs_get_option()
...
* Tweak: Improved performance for cs_get_sales_tax_for_year()
* Fix: Yesterday view for reports and REST API fails when on the first day of the month
* Fix: CS_Download class missing default properties from WP_Post
* Fix: Removed unused function calls in PDF reports and upgrade functions
* Fix: Deprecated cs_get_cart_subtotal() function called with too many arguments
* Fix: cs_get_cart_item_price() function called with too many arguments
* Fix: cs_remove_item_url() function called with too many arguments
* Fix: Improper start_date declaration in CLI class
* Fix: Missing variable declaration in CS_SL_Plugin_Updater class
...
* Fix: Instantiating CS_Payment_Stats without a date triggers an error
...
* New: Introduced cs_global_checkout_script_vars and cs_ajax_script_vars filters for localized javascript variables
* Bug: Strict PHP Standards notice in CS_Gateway_Error_Log class
...
* Bug: CS_Session leaks across sites in multisite installs
...
* Tweak: Use get_posts() instead of query_posts() in cs_get_*_by() functions
* Tweak: Improved flexibility for CS()->html->year_dropdown() to support larger year spans
* Tweak: Added NZD currency symbol
* Tweak: Improved support for Polylang plugin via cs_get_option() standardization
...
* Bug: cs_get_current_page_url() returns localhost in HHVM
...
* Fix: cs_test_ajax_works() request firing on every page load
...
* Fix: Removed unused variables in cs_get_register_fields()
...
* New: Added support for variable prices to the [cs_price] shortcode
* New: CS_Download class to make interacting with Download products easier for theme and extension developers
* New: cs_cart_item_tax_description filter
* New: Purchase buttons can now display a quantity field
* New: CS_Fees API now supports per-product fees
...
* Fix: cs_settings_sanitize does not respect all field type specific filters such as cs_settings_sanitize_$type
...
* Fix: Pagination doesn't work on /cs-api/customers
...
* Tweak: Add Today to the default response for /cs-api/stats
...
* Fix: cs_settings_sanitize filter returning incorrect value
...
* Tweak: Introduced cs_email_tag_bundled_products filter
* Tweak: Pass the payment ID to the cs_get_price_option_name function() calls
* Tweak: Add the price ID to the cs_get_price_option_name filter
...
* Tweak: Verify payment update was successful during cs_update_payment_details
...
* Fix: cs_has_user_purchased() returning true improperly
...
* Fix: cs_record_sale_in_log() not respecting purchase date for imported sales
...
* New: Redesigned email templates powered by the new CS_Emails class
...
* New: cs_update_payment_meta() function for easily adding and updating meta values for payment records
* New: cs_update_payment_meta() function for easily adding and updating meta values for payment records
...
* New: Introduced a function to detect if a download product is free, cs_is_free_download()
* New: Introduced cs_get_payment_transaction_id() and cs_set_payment_transaction_id()
* New: Introduced cs_user_can_view_receipt_item filter
...
* Tweak: Added CS-specific classes to the body tag when appropriate
* Tweak: Improved responsiveness of the View Order Details screen
* Tweak: Added "download" attribute to file download links
* Tweak: Parameters for cs_get_download_file_url() now passed through urlencode()
...
* Tweak: Added caching to the get_user() method in the CS_API
* Tweak: Added a "size" parameter to the cs_rich_editor_callback() function

* Fix: Sales column linked incorrectly to the File Downloads log
* Fix: "yesterday" date range failed for CS_Stats when the current day was the first day of the month
...
* Fix: cs_before_download_content action ran after the download content
...
* New: Added a new [cs_register] shortcode
...
* New: Added a template file for the [cs_login]
...
* New: Added textarea support to the CS_HTML_Elements class
* New: Added support for exporting customers of a specific product and a specific price option
* New: Introduced cs_get_*_by() functions for downloads and discounts
* New: Introduced a cs_get_users_purchased_products() function
* New: Introduced a cs_is_host() function
...
* Tweak: Added a columns variable to the cs_download_class filter
* Tweak: Added tax settings to the System Info
* Tweak: Added improved hooks to the cs_shopping_cart() function
...
* Tweak: Added $payment_id to the cs_view_order_details_form_top action
...
* Bug: cs_before_download_content action fired too early
...
* Bug: Custom events not purged from WP Cron when CommerceStore is deactivated
* Bug: Dates for "Last Quarter" incorrect Custom reports
* Bug: Filtering payment history by a guest user fails
* Bug: CS_Payments_Query cannot be instantiated multiple times
...
* Bug: Removed duplicate call to cs_get_payment_meta()
* Bug: Removed duplicate comma in cs.css
...
* Tweak: Added $payment_id to cs_payment_amount filter
* Tweak: Added $payment_id to cs_view_order_details_form_top filter
...
* New: Introduced an cs_is_success_page() function
* New: Introduced a filter on the cs_get_variable_prices() function
* New: Added Offer schema.org markup
* New: Added cs_get_sales_args filter
* New: Added cs_get_cart_content_details_item_discount_amount filter
* New: Added cs_get_cart_item_tax_item_discount_amount filter

* Tweak: Added $payment_id to the cs_email_receipt_download_title filter
...
* Fix: Improper HTML for text fields through CS_HTML_Elements class
* Fix: Improper HTML for checkbox fields through CS_HTML_Elements class
* Fix: Broken cache key in CS_Payment_Stats
* Fix: Properly account for when global $post isn't available in cs_get_purchase_link()
...
* Fix: Do not retrieve user if no key is set in CS_API
* Fix: Fatal error when installing CommerceStore via WP CLI
* Fix: Typo in Australian states function
* Fix: Undefined index in cs_count_purchases_of_customer()
...
* Fix: cs_get_chosen_gateway() doesn't respect default gateway
...
* Tweak: Improve _cs_deprecated_function() to actually pass the backtrace
...
* Tweak: Allow array of download IDs to be passed to CS_Payments_Query
* Tweak: Added floatval() to cs_get_payment_amount()
* Tweak: Properly format number in Sales column
* Tweak: Color code axes on graphs when there are multiple axes
* Tweak: Removed error suppression from cs_readfile_chunked()
...
* Fix: Restored functionality of cs_get_purchase_download_links() function
...
* Fix: Incorrect variable name in cs_get_cart_item_final_price()

* Tweak: Dramatic performance improvement to payment queries throughout the admin
* Tweak: Rework cs_get_earnings_by_date() to be much more performant
* Tweak: Rework cs_get_total_earnings() to be much more performant
* Tweak: Rework CS_Payment_Stats::get_earnings() to be much more performant
* Tweak: Removed Files Downloaded count from customer reports due to it being too expensive
* Tweak: Rework cs_get_purchase_stats_by_user() to be much more performant
...
* Tweak: Updated all language files for CommerceStore 1.9+
...
* New: Allow the CommerceStore templates directory to be modified via plugins or themes
...
* New: Added a "cs-payment-type-selected" class to the chosen payment gateway during checkout
...
* New: Added CS_Email_Template_Tags class and helper functions give developers a simple way to register new email tempalte tags
* New: Added CS_Graph class to allow developers to easily display custom graphs in add-ons and themes
* New: Added live ajax search to all product drop-downs in the admin to dramatically improve performance of CommerceStore on stores with a lot of products
...
* Fix: Undefined index when using cs_action=straight_to_gateway and variable prices
...
* Fix: CS_Fees doesn't properly sanitizes amounts before adding up the total
...
* Fix: cs_settings_sanitize prevents CommerceStore settings from being modified via update_option()
...
* Tweak: Better setup CS_Roles during initial installation
...
* Tweak: add cs_get_option() helper function
* Tweak: enable mobile app link to be removed
* Tweak: pass $item along with cs_email_receipt_download_title filter
* Tweak: map lowest price option amount to cs_price
...
* Fix: a bug that prevented CommerceStore cron events from firing
* Fix: incorrect display of negative amounts for CS_Fees

= 1.8.3: November 4, 2013 =

* New: added cs_payment_receipt_after_table hook
...
* Tweak: Added filters to admin script loaders so extensions can enable core CommerceStore scripts on custom pages
...
* New: introduced CS_Payments_Query class for querying payment records
* New: introduced CS_Payment_Stats class for querying earnings and sales data
* New: introduced CS_Stats base class to be extended by other classes for retrieving data-based data
* New: added settings and donate links to plugin action links
* New: add email tags for billing address
* New: added address fields to [cs_profile_editor] to allow customers to update their stored billing address
* New: add status options to Payment History bulk action menu to allow payment statuses to be updated in bulk
* New: added WP Heartbeat API to the CommerceStore Dashboard summary widget for live dashboard updating
...
* Fix: cs_download_history_row_end action passed wrong variable
...
* Fix: AJAX loading indicator breaks if cs.css is moved to cs_templates folder
...
* Tweak: added hex values to cs_get_button_colors()
* Tweak: added form_id attribute to [cs_purchase_link]
* Tweak: dramatically improved the CommerceStore settings API
...
* Tweak: fire cs_create_protection_files() on install process to ensure .htaccess file is created in uploads/commercestore directory
...
* New: Added new post installation hook: cs_after_install
...
* Tweak: Added HTTP status headers to the CS_API class
...
* Tweak: Changed the capability of the CommerceStore Add Ons page
...
* Fix: Incorrect usage of cs_log_test_payment_stats filter
...
* Fix: Incorrect status check in cs_process_paypal_web_accept_and_cart
...
* Tweak: Added $tax to the cs_cart_item_price filter
...
* Fix: Fix equality operator in cs_get_download_files()
...
* Fix: Issue with cs_before/after_download_content hooks being added on pages that are not Downloads
...
* New: Introduced CS_Cron class for scheduling routine events
...
* Tweak: Show payment status in [cs_receipt]
...
* Tweak: Better default stats response in CS_API
...
* New: The price option purchased is now shown in [cs_receipt]
* New: Added get_output() method to the CS_API
* New: Added new "upgraded from" option to better help with support issues
* New: Added symlinks on/off to System Info
* New: Added a link to the CommerceStore iOS sales / earnings tracker
...
* Fix: SQL error with comments_clauses
* Fix: CS_API retrieved pending sales when it shouldn't
* Fix: Default currency now set
* Fix: Issue with cs_show_added_to_cart_messages() showing on incorrect pages
* Fix: Force redirect when adding items to the cart from the checkout page
* Fix: CS_API &number=-1 returned null
...
* New: Added [CS_API class](https://github.com/commercestore/CommerceStore/issues/857) to provide a fully RESTful API to retrieve sales and earnings stats
...
* New: Added [arbitrary cart fees class](https://github.com/commercestore/CommerceStore/issues/418)
...
* Fixed: Missing parameter in cs_log_user_in()
...
* New: Added new CS_Export class to more flexible export system
* New: Pages are auto created and saved to the CommerceStore options on activation
...
* New: Introduced cs_get_lowest_price_option() and cs_get_highest_price_option()
...
* New: Added new cs_show_has_purchased_item_message filter
...
* New: Added sample product import xml file in commercestore/assets/
...
* Fix: Admin gateway label was showing on the [cs_receipt] instead of the front end label
...
* New: Ability to set own error class/classes in cs_print_errors() function
* New: Add support for .apk (props @chriscct7)
* Tweak: Use AJAX & session with 'local residents only'
* Tweak: Ajax Local Tax Opt-In
* Tweak: Refractor cs_process_profile_editor_updates()
...
* Tweak: Don't Show Discount if None was Used on [cs_receipt]
* Tweak: Remove Subtotal and Taxes if Taxes Disabled  [cs_receipt]
* Tweak: Payment Notes Showing Up in Comment Streams
* Fix: Pagination Not Working Fully on File Download Logs
* Fix: New option to make Supercache compatible with CommerceStore (props @chriscct7)
...
* Fix: Calculate the tax price in cs_get_cart_content_details() when tax inclusive
...
* New: Travis now autoloads all of CommerceStore (props @chriscct7)
...
* Tweak: Updated cs_get_user_purchases()
* Tweak: Made some UI tweaks, and bug fixes for Logs
* Tweak: Made updates to cs_process_download()
...
* New: Added date parameters to cs_get_payments() to allow payments of specific dates to be queried
...
* Fix: Path to custom cs.css
* Fix: Problem with some payments not having meta data for the total amount recorded
* Tweak: Improved contextual help tabs
* Tweak: Made the cs_log_type taxonomy private
* Tweak: Updated category/tag slugs to respect CS_SLUG constant (if defined)
* Tweak: Updated Italian language files
...
* Tweak: Improved cs_get_ajax_url() to fix problems with sites that use SSl
* Tweak: Improved the way language files are loaded to permit users to place custom language files in wp-content/languages/cs/
...
* New: Added new cs_file_download_has_access filter
...
* Tweak: Improved markup for the [cs_price] shortcode
...
* New: Added new "cs_checkout_form_bottom" hook
...
* New: Added new cs_ajax_url filter
* New: Added new cs_cart_total() function for showing fully formatted cart amount
...
* Fix: Bug with cs_get_sales_by_date()
...
* New: Added new cs_get_purchase_id_by_key() function, props Yoast
* New: Added Recent Purchases to the Dashboard widget
* New: Added new cs_add_to_cart_item filter for modifying the item info when adding items to the cart
...
* New: Added new cs_price_field action to the download meta box
...
* New: Added upgrade routine for converting old file download and purchase logs to the new CS_Logging class
* New: Added new upgrade routine for handling database upgrades
* New: Added a new CS_Logging class for logging events
...
* Fix: Bug with creating the blank index.php in wp-content/uploads/commercestore/
* Fix: Bug with an HTML class name in cs_get_purchase_link()
...
* New: cs_before_download_content hook
* New: cs_purchase_history_files hook
* New: filter for cs_is_checkout
...
* Tweak: Updated French language files
* Tweak: Updated cs_email_template_tags with $payment_id
...
* New: Added a new filter for cs_receipt_attachments
...
* New: Added new filter to the CommerceStore languages directory
* New: Added new CSS for improved styling of checkout error messages
* New: Added new filter to cs_get_checkout_uri
...
* New: Added a new cs_get_payments_args filter
* New: Added the ability to sort payments by their total price
* New: Added new cs_payments_page_date_format filter to allow date format in Payment History to be changed
...
* New: Added new cs_download_post_type_args filter
...
* Tweak: Improved the cs_append_purchase_link() function
...
* Tweak: Improved the cs_delete_purchase() function
...
* New: Added a new cs_download_price filter to the cs_price() function
...
* Fix: Incorrect check for missing directory and creation of /uploads/commercestore
...
* Tweak: Removed call by reference in cs_scan_folders()
...
* New: Added new cs_get_current_page_url() function
...
* Tweak: Updated the cs_remove_item_url() to use the current page URL instead of the home URL
* Tweak: Made the cs_payment post type not public
* Tweak: Updated French language files
...
* New: Added a new [cs_price] shortcode
* New: Added new cs_cart_contents filter
...
* Tweak: Removed the cs_payment post type from the WP Nav Menus
...
* New: Added new cs_is_checkout() conditional function
...
* New: Added a new hook, cs_process_verified_download, to the download processing function
...
* Tweak: Updated cs_sert_payment() to apply the date of the payment to the post_date field
* Tweak: Updated default language files
...
* New: Added a new filter, cs_download_file_url_args,  for changing the arguments passed to the function that generages download URLs
* New: Added a new filter to allow developers to change the redirect URL for the cs_login form
* Fix: Bug with the CS_READ_FILE_MODE constant
...
* Tweak: Updated the cs_read_file() function to convert local URLs to absolute file paths
...
* New: Added new constant CS_READ_FILE_MODE for defining how download files are delivered
* New: Added auto creation for .htaccess files in the uploads directory for CommerceStore to help protect unauthorized file downloads
...
* New: Added new "cs_default_downloads_name" filter for changing the default singular and plural "download" labels used globally throughout the plugin
* New: Adding new span.cs-cart-item-separator to the cart widget and shortcode
...
* New: Added new "cs_success_page_redirect" filter to the function that redirects a buyer to the success page
...
* Tweak: Reorganized the cs_complete_purchase() function to be more extensible

= 1.0.8.2: May 31, 2012 =

* New: Added a number_format() check to the PayPal standard gateway
* New: Added the Turkish Lira to supported currencies
* New: Added new cs_hook_callback() function for settings field type callbacks
* New: Added cs_get_ip() and updated the user IP detection. It previously failed if the server was running SSL
* New: Added missing class name to the download history table
* New: Added a new conditional called cs_no_redownload() that theme devs can use to check if redownloading of files is permitted
...
* New: Added new filter called "cs_payment_statuses", which can be used to register custom statuses
...
* New: Added the cs_get_checkout_uri() function for use by themes
* Fix: Incorrectly named parameter in the cs_after_download_content hook
...
* New: Added a new CommerceStore Categories / Tags widget
...
* New: Added a second instance do_action('cs_purchase_form_user_info') to the checkout registration form
* New: Added a wrapper div.cs-cart-ajax-alert around the message that shows when an item has been added to the cart
...
* Fix: Small bug wit the cs_remove_item_url() present when on a 404 error page. Props to Sksmatt
* Tweak: Updated the cs_purchase_link() function to automatically detect chosen link styles and colors

= 1.0.7: May 08, 2012 =

* New: cs_has_variable_prices() function
...
* New: Added a new [cs_login] shortcode for showing a basic login form
* New: Added new Dutch language translation files
* New: Added an $id parameter to the cs_cart_item filter
* Tweak: Updated French language files
* Tweak: Improved the cs_price() function to take into account products with variable prices
...
* New: Added the cs_price() function for use in themes
...
* Fix: Bug with plugin pages being duplicate on reactivation of CS
...
* Tweak: Updated the cs_payment_meta filter with a second parameter for $payment_data
...
* Fix: Improperly named filter for "cs_payment_meta"
...
* Released on WordPress.org (we consider this date CS's official birthday)
* New: Inclusion of INR as an available currency.
* Fix: Updates to the default.po file for missing strings.

= 1.0: April 7, 2012 =

* CommerceStore is born. This release was only available via download at https://commercestore.com/blog/commercestore-ready-for-first-beta-testers/ or via GitHub. We launched on WordPress.org 10 beta versions later on April 15th as version 1.0.1.1. We consider April 15, 2012, CS's birthday.
