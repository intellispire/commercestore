...
function setupEmailTags() {
  ...
  var insertButtons = document.querySelectorAll('.cs-email-tags-list-button');
...
function filterEmailTags() {
  var filterInput = document.querySelector('.cs-email-tags-filter-search');
  var tagItems = document.querySelectorAll('.cs-email-tags-list-item');
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var mediaButton = document.querySelector('.cs-email-tags-inserter');
...
/******/ });
//# sourceMappingURL=cs-admin-email-tags.js.map