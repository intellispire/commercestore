 ...
 * @group database
 *
 * @coversDefaultClass \CS\Orders\Order_Transaction
 */
class Order_Transaction_Tests extends \CS_UnitTestCase {
	...
	/**
	 * @covers ::cs_update_order_transaction
	 */
	public function test_update_should_return_true() {
		$success = cs_update_order_transaction( self::$order_transactions[0], array(
			'gateway' => 'stripe',
		) );
	...
	public function test_order_object_after_update_should_return_true() {
		cs_update_order_transaction( self::$order_transactions[0], array(
			'gateway' => 'stripe',
		) );

		$order_transaction = cs_get_order_transaction( self::$order_transactions[0] );
	...
	public function test_update_without_id_should_fail() {
		$success = cs_update_order_transaction( null, array(
			'gateway' => 'stripe',
		) );
	...
	public function test_delete_should_return_true() {
		$success = cs_delete_order_transaction( self::$order_transactions[0] );
	...
	public function test_delete_without_id_should_fail() {
		$success = cs_delete_order_transaction( '' );

		$this->assertFalse( $success );
	}

	/**
	 * @covers ::cs_get_order_transactions
	 */
	public function test_get_order_transactions_with_number_should_return_true() {
		$orders = cs_get_order_transactions( array(
			'number' => 10,
		) );
	...
	public function test_get_order_transactions_with_offset_should_return_true() {
		$order_transactions = cs_get_order_transactions( array(
			'number' => 10,
			'offset' => 4,
		) );
	...
	public function test_get_order_transactions_with_invalid_id_should_return_0() {
		$transactions = cs_get_order_transactions( array(
			'id' => -999,
		) );
