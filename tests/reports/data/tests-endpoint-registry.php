 ...
 *
 * @coversDefaultClass \CS\Reports\Data\Endpoint_Registry
 */
class Endpoint_Registry_Tests extends \CS_UnitTestCase {
	...
	public function test_get_endpoint_with_invalid_endpoint_id_should_return_an_empty_array() {
		$this->setExpectedException( '\CS_Exception', "The 'foo' reports endpoint does not exist." );
	...
	public function test_register_endpoint_with_empty_views_should_throw_exception() {
		$this->setExpectedException(
			'\CS\Reports\Exceptions\Invalid_Parameter',
			"The 'views' parameter for the 'foo' item is missing or invalid in 'CS\Reports\Registry::validate_attributes'."
		);
	...
	public function test_build_endpoint_with_Endpoint_object_should_return_that_object_unchanged() {
		...
		$this->assertInstanceOf( '\CS\Reports\Data\Endpoint', $endpoint );
	}
	...
	public function test_validate_views_with_invalid_view_should_throw_exception() {
		$this->setExpectedException(
			'\CS\Reports\Exceptions\Invalid_View',
			"The 'fake' view for the 'foo' item is missing or invalid in 'CS\Reports\Data\Endpoint_Registry::validate_views'"
		);
