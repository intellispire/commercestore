 ...
 * @group database
 *
 * @coversDefaultClass \CS\Customers\Customer_Address
 */
class Customer_Address_Tests extends \CS_UnitTestCase {
	...
	public static function wpsetUpBeforeClass() : void  {
		self::$customer_addresses = parent::cs()->customer_address->create_many( 5 );
	}

	/**
	 * @covers ::cs_update_customer_address
	 */
	public function test_update_should_return_true() {
		$success = cs_update_customer_address( self::$customer_addresses[0], array(
	...
	public function test_address_object_after_update_should_return_true() {
		cs_update_customer_address( self::$customer_addresses[0], array(
			'address' => 'Address Line 1',
		) );

		$customer_address = cs_fetch_customer_address( self::$customer_addresses[0] );
	...
	public function test_update_without_id_should_fail() {
		$success = cs_update_customer_address( null, array(
	...
	public function test_delete_should_return_true() {
		$success = cs_delete_customer_address( self::$customer_addresses[0] );
	...
	public function test_delete_without_id_should_fail() {
		$success = cs_delete_customer_address( '' );

		$this->assertFalse( $success );
	}

	/**
	 * @covers ::cs_get_customer_addresses
	 */
	public function test_get_customer_addresses_with_number_should_return_true() {
		$orders = cs_get_customer_addresses( array(
			'number' => 10,
		) );
	...
	public function test_get_customer_addresses_with_offset_should_return_true() {
		$customer_addresses = cs_get_customer_addresses( array(
			'number' => 10,
			'offset' => 4,
		) );
	...
	public function test_get_customer_addresses_with_invalid_id_should_return_0() {
		$transactions = cs_get_customer_addresses( array(
			'id' => -999,
		) );
	...
	/**
	 * @covers ::cs_demote_customer_primary_addresses
	 */
	public function test_adding_new_primary_customer_address_demotes_previous_primary() {
		$old_primary_address = parent::cs()->customer_address->create_and_get( array(
			'is_primary' => true
		) );

		$this->assertEquals( '1', $old_primary_address->is_primary );

		$number_primary_addresses = cs_count_customer_addresses( array(
			'is_primary'  => true,
		...
		$new_primary_address = parent::cs()->customer_address->create_and_get( array(
			'is_primary'  => true,
			'customer_id' => $old_primary_address->customer_id
		) );
		...
		$old_primary_address = parent::cs()->customer_address->get_object_by_id( $old_primary_address->id );
	...
	public function test_adding_new_non_primary_customer_address_doesnt_demote_primary() {
		$primary_address = parent::cs()->customer_address->create_and_get( array(
			'is_primary' => true
		) );
		...
		$non_primary_address = parent::cs()->customer_address->create_and_get( array(
			'is_primary'  => false,
		...
		$primary_address = parent::cs()->customer_address->get_object_by_id( $primary_address->id );
		$this->assertEquals( '1', $primary_address->is_primary );
	}
}
