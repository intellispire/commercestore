 ...
 * @group cs_logs
 *
 * @coversDefaultClass \CS_Log_API_Request_Query
 */
class Api_Request_Logs_Tests extends \CS_UnitTestCase {
	...
	public function test_update_should_return_true() {
		$success = cs_update_api_request_log( self::$logs[0], array(
			'ip' => '10.0.0.1',
		) );
	...
	public function test_log_object_after_update_should_return_true() {
		...
		$log = cs_get_api_request_log( self::$logs[0] );
	...
	public function test_update_without_ip_should_fail() {
		$success = cs_update_api_request_log( null, array(
			'ip' => '10.0.0.1',
		) );
	...
	public function test_delete_should_return_true() {
		$success = cs_delete_api_request_log( self::$logs[0] );
	...
	public function test_delete_without_id_should_fail() {
		$success = cs_delete_api_request_log( '' );
	...
	public function test_count() {
		$this->assertEquals( 5, cs_count_api_request_logs() );
	}
