...
class Order_Adjustment extends \WP_UnitTest_Factory_For_Thing {
	 ...
	 *
	 * @return \CS\Orders\Order_Adjustment|false
	 */
	...
	public function create_object( $args ) {
		return cs_add_order_adjustment( $args );
	}

	public function update_object( $order_adjustment_id, $fields ) {
		return cs_update_order_adjustment( $order_adjustment_id, $fields );
	}

	public function delete( $order_adjustment_id ) {
		cs_delete_order_adjustment( $order_adjustment_id );
	}
	...
	public function get_object_by_id( $order_adjustment_id ) {
		return cs_get_order_adjustment( $order_adjustment_id );
	}
}