 ...
 * @method \CS\Orders\Order_Address create_and_get( $args = array(), $generation_definitions = null )
...
class Order_Address extends \WP_UnitTest_Factory_For_Thing {
	...
	public function create_object( $args ) {
		return cs_add_order_address( $args );
	}

	public function update_object( $order_address_id, $fields ) {
		return cs_update_order_address( $order_address_id, $fields );
	}

	public function delete( $order_address_id ) {
		cs_delete_order_address( $order_address_id );
	}
	 ...
	 *
	 * @return \CS\Orders\Order_Address|false
	 */
	public function get_object_by_id( $order_address_id ) {
		return cs_get_order_address_by( $order_address_id );
	}
}
