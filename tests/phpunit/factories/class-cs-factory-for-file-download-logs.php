...
class File_Download_Log extends \WP_UnitTest_Factory_For_Thing {
	 ...
	 *
	 * @return \CS\Logs\File_Download_Log|false
	 */
	...
	function create_object( $args ) {
		return cs_add_file_download_log( $args );
	}

	function update_object( $log_id, $fields ) {
		return cs_update_file_download_log( $log_id, $fields );
	}

	public function delete( $log_id ) {
		cs_delete_file_download_log( $log_id );
	}
	...
	function get_object_by_id( $log_id ) {
		return cs_get_file_download_log( $log_id );
	}
}