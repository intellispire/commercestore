 ...
 * @method \CS\Orders\Order_Transaction create_and_get( $args = array(), $generation_definitions = null )
...
class Order_Transaction extends \WP_UnitTest_Factory_For_Thing {
	...
	public function create_object( $args ) {
		return cs_add_order_transaction( $args );
	}

	public function update_object( $order_transaction_id, $fields ) {
		return cs_update_order_transaction( $order_transaction_id, $fields );
	}

	public function delete( $order_transaction_id ) {
		cs_delete_order_transaction( $order_transaction_id );
	}
	 ...
	 *
	 * @return \CS\Orders\Order_Transaction|false
	 */
	public function get_object_by_id( $order_transaction_id ) {
		return cs_get_order_transaction( $order_transaction_id );
	}
}