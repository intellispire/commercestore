...
class API_Request_Log extends \WP_UnitTest_Factory_For_Thing {
	...
	function __construct( $factory = null ) {
		...
		$this->default_generation_definitions = array(
			...
			'request' => new \WP_UnitTest_Generator_Sequence( 'cs-api=sales&key=b8062c469b938352k3bg4656999ed%1$d&token=b8062c469b938352k3bg4656999ed%1$d' ),
			'version' => 'v2',
			'ip'       => '10.1.1.1',
	 ...
	 *
	 * @return \CS\Logs\Api_Request_Log|false
	 */
	...
	function create_object( $args ) {
		return cs_add_api_request_log( $args );
	}

	function update_object( $log_id, $fields ) {
		return cs_update_api_request_log( $log_id, $fields );
	}

	public function delete( $log_id ) {
		cs_delete_api_request_log( $log_id );
	}
	...
	function get_object_by_id( $log_id ) {
		return cs_get_api_request_log( $log_id );
	}
}