 ...
 * @method \CS\Customers\Customer_Address create_and_get( $args = array(), $generation_definitions = null )
...
class Customer_Address extends \WP_UnitTest_Factory_For_Thing {
	...
	public function create_object( $args ) {
		return cs_add_customer_address( $args );
	}

	public function update_object( $customer_id, $fields ) {
		return cs_update_customer_address( $customer_id, $fields );
	}

	public function delete( $customer_id ) {
		cs_delete_customer_address( $customer_id );
	}
	 ...
	 *
	 * @return \CS\Customers\Customer_Address|false
	 */
	public function get_object_by_id( $customer_address_id ) {
		return cs_fetch_customer_address( $customer_address_id );
	}
}
